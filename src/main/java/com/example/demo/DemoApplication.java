...
public class DemoApplication {
	...
	//getting memory, cpu stats
		...
		try {
			...
			CpuUsageConfig cpuConfig = cpuStats.getCpuUsage();
			String retStr = "Total Usage: " + cpuConfig.getTotalUsage().toString()
					+ " Kernal mode Usage: " + cpuConfig.getUsageInKernelmode()
					+ " User mode Usage: " + cpuConfig.getUsageInUsermode();
	...
	*/
		...
		//System.out.println("Total Usage: " + totUsg);
		//MemoryStatsConfig memStats = stats.getMemoryStats();
		//long usage = memStats.getUsage();
		//System.out.println(usage);
		//System.out.println("CPU Usage: " + stats.toString()+ "/n");
